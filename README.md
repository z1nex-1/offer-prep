...
Отдельный раздел `/iwo` — курс на Python для двух направлений, бэкенда и ML: от первой программы до уровня отборочного контеста и технических секций. Направление выбирается в хабе курса, у каждого свои даты, формат контеста, модули, диагностика и план; Python и алгоритмы общие.
...
- **Уроки по модулям** — Python, сложность, массивы, хеш-таблицы, сортировки, жадные алгоритмы, бинпоиск, префиксные суммы, стек и очередь, рекурсия, деревья, графы, куча, динамика, строки, теория бэкенда; для ML — метрики и валидация, классические модели, ML в коде на NumPy и чистом Python, математика, нейросети. В каждом уроке код, типичные ошибки, сложность, самопроверка и вопросы, которые задают на собеседовании. Сведения об отборе Яндекса — только со ссылками на источники.
- **Задачи в формате Яндекс Контеста**: stdin/stdout, эталонное решение, генератор тестов, сверенных с перебором, вердикты OK/WA/RE/TL в Pyodide. В ML-задачах можно писать на NumPy; ответы эталонов сверены со sklearn и NumPy.
